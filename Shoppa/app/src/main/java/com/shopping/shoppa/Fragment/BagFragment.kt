package com.shopping.shoppa.Fragment
...
import com.shopping.shoppa.Adapter.CartAdapter
import com.shopping.shoppa.Adapter.CartItemClickAdapter

import com.shopping.shoppa.R
...
class BagFragment : Fragment(), CartItemClickAdapter {
    ...
    lateinit var plus:LinearLayout
    lateinit var minus:LinearLayout
     var sum:Int = 0
