...
import com.shopping.shoppa.Adapter.ProductAdapter
import com.shopping.shoppa.Model.Product
import com.shopping.shoppa.Utils.DefaultCard.GetDefCard
import com.shopping.shoppa.Utils.Extensions.cardXXGen
import com.shopping.shoppa.Utils.Extensions.toast
import com.shopping.shoppa.db.CartViewModel
import com.shopping.shoppa.db.ProductEntity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addToCart_ProductDetailsPage.setOnClickListener {
            ...
            bottomSheetView.findViewById<LinearLayout>(R.id.plusLayout).setOnClickListener {
                if(bottomSheetView.findViewById<EditText>(R.id.quantityEtBottom).text.toString().toInt() < 10){
                    qua++
                    bottomSheetView.findViewById<EditText>(R.id.quantityEtBottom).setText(qua.toString())
                }
            }
